...
# Run TassieAgent on OpenThoughts-TBLite with Claude models (Daytona backend)
...
#   JOB_NAME           - Job name for resumability (default: tblite_claude)

MODEL="${MODEL:-anthropic/claude-sonnet-4-20250514}"
N_CONCURRENT="${N_CONCURRENT:-25}"
MAX_STEPS="${MAX_STEPS:-50}"
JOB_NAME="${JOB_NAME:-tblite_claude}"
