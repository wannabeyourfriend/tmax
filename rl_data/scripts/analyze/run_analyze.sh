...
TASKS_DIR="${TASKS_DIR:-/gpfs/scrubbed/osey/tmax/rl_data/output/tasks_skill_tax_20260505_2.2k_combined_balanced}"

PLOTS_DIR="${PLOTS_DIR:-}"   # leave empty to default to <TASKS_DIR>/analysis
MODEL="${MODEL:-}"       # e.g. "gemini/gemini-3-flash-preview"; leave empty to auto-discover all models
...
HARNESS="${HARNESS:-}"
MAX_ROWS="${MAX_ROWS:-50}"    # 0 to show all per-task rows
